...
module.exports = {
  title: "Tokenflow",
  description: "Temporally consistent video editing. A local version of https://huggingface.co/spaces/weizmannscience/tokenflow",
  icon: "icon.gif",
  menu: async (kernel) => {
    let installed = await exists(path.resolve(__dirname, "tokenflow", "env"))
    if (installed) {
